from PySide6.QtWidgets import QFileDialog, QApplication, QMainWindow, QPushButton, QLabel, QComboBox, QRadioButton, QVBoxLayout, QWidget
...
class CombinedCSVViewer(QMainWindow):
    ...
    def create_widgets(self):
        ...
        # Radio Buttons
        self.radio_var = "Графики"  # Default selection
    ...
    def update_combobox_values(self):
        if self.csv_data is not None:
            ...
            for combo, label in zip([self.combo1, self.combo2, self.combo3], [self.combo1_label, self.combo2_label, self.combo3_label]):
                combo.clear()
    ...
    def change_language(self, index):
        if index == 0:
            self.translate("ru")  # Translating to Russian
        elif index == 1:
            self.translate("en")  # Translating to English
        elif index == 2:
            self.translate("pt")  # Translating to Portuguese
        elif index == 3:
            self.translate("es")  # Translating to Spanish
        elif index == 4:
            self.translate("fr")  # Translating to French
        elif index == 5:
            self.translate("de")  # Translating to German
        elif index == 6:
            self.translate("it")  # Translating to Italian
        elif index == 7:
            self.translate("pl")  # Translating to Polish
        elif index == 8:
            self.translate("tr")  # Translating to Turkish
        elif index == 9:
            self.translate("ar")  # Translating to Arabic
        elif index == 10:
            self.translate("zh")  # Translating to Chinese
        elif index == 11:
            self.translate("ja")  # Translating to Japanese
